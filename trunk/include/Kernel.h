...
enum enum_errosKernel{
	...
	KERNEL_ERRO_MEMORIA_DISCO_INSUFICIENTE,
	...
	KERNEL_ERRO_ARQUIVO_ABERTO_COM_OUTRO_FIM,
	KERNEL_ERRO_OPERACAO_RPC_INVALIDA,
	KERNEL_ERRO_NAO_IDENTIFICADO,
	KERNEL_ERRO_PROCESSO_INEXISTENTE
};
