...
int main(void)
{
	...
	//tela_escreverNaColuna(&global_tela, "Estah eh a mensagem de coluna um e ela eh muito grande. Tao grande que vai ter que ser enrolada em novas linhas.",3);
	//tela_escreverNaColuna(&global_tela, "Estah eh a mensagem de coluna um e ela eh muito grande. Tao grande que vai ter que ser enrolada em novas linhas.",4);
